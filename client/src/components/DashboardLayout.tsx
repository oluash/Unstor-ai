...
import { LayoutDashboard, LogOut, PanelLeft, MessageCircle, BookOpen, Rss, FlaskConical, Brain, Atom, Shield, Library, Microscope } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Microscope, label: "Research Digest", path: "/research" },
