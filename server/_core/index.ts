...
import { startAutonomousEngine } from "../autonomousEngine";
...
async function startServer() {
  ...
  // Health check endpoint for Railway/Render/Vercel deployment
  app.get("/api/health", (_req, res) => res.json({ status: "ok", service: "unstor-ai" }));
  ...
  if (port !== preferredPort) {
   ...
   server.listen(port, () => {
    ...
    startResearchAgent();
    // Start Unstor autonomous operation engine (consolidation, readiness, Odu enrichment)
